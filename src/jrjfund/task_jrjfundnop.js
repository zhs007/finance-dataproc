...
const { TASK_NAMEID_JRJFUND_NOP } = require('../taskdef');
const { FinanceMgr } = require('../financemgr');
const { MysqlMgr } = require('../mysqlmgr');
// const { saveJRJFundNop } = require('./jrjfundnop');

class TaskJRJFundNOP extends Task {
    constructor(taskfactory, cfg) {
        super(taskfactory, TASK_NAMEID_JRJFUND_NOP, cfg);
    }
...
taskFactory.regTask(TASK_NAMEID_JRJFUND_NOP, (taskfactory, cfg) => {
    return new TaskJRJFundNOP(taskfactory, cfg);
});

exports.TaskJRJFundNOP = TaskJRJFundNOP;